...
def about_notepad():
    ...
    info_label = Label(info,
                       text='Notepad is an app developed by Revti tiwati.\n It is an open-sourced notepad application.\n'
                            ...
                            'Creator - Revti tiwari', fg='black', bg='white')
...
def navigation():
    ...
    navigate_label = Label(navigate_frame, text='Welcome to Notepad Navigation!\n\n\n'
...
def terms():
    ...
    terms_label = Label(terms_frame, text='Terms And Conditions - Notepad\n \n \n \n'
